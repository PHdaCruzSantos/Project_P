import type { Clerk, ClerkOptions, ClientResource, DomainOrProxyUrl, LoadedClerk, MultiDomainAndOrProxy, SDKMetadata, Without } from '@clerk/types';
declare global {
    interface Window {
...
export type ClerkProp = BrowserClerkConstructor | BrowserClerk | HeadlessBrowserClerk | HeadlessBrowserClerkConstructor | undefined | null;
